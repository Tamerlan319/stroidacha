...
// yclid — не UTM, а метка клика, которую Директ сам добавляет к адресу. Живёт
// рядом с метками по той же причине: нужна заявке после переходов по сайту,
// чтобы реальную заявку можно было привязать к рекламному клику офлайн-
// конверсией.
