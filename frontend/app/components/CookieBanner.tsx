  ...
  const panel = (
    ...
    >
      <div className={styles.content}>
        ...
        {/* Текст говорит правду о том, что происходит: Метрика уже работает
            с входа на сайт (YandexMetrika.tsx), а «Только необходимые» её
            действительно отключает. Кнопка отказа, которая ничего не
            выключает, была бы обманом посетителя. */}
        <p id="cookie-banner-text">
          Сайт использует cookie-файлы, чтобы сделать ваше пребывание на нём
          максимально удобным. К сайту подключён сервис веб-аналитики Яндекс
          Метрика, использующий cookie-файлы, — он работает с момента входа на
          сайт. Нажимая «Принять все», вы даёте согласие на обработку
          персональных данных в порядке, указанном в{" "}
          <Link href="/privacy">Политике обработки персональных данных</Link> и{" "}
          <Link href="/cookies">политике cookie</Link>, и включаете карты
          Яндекса. Не согласны — нажмите «Только необходимые», и Метрика
          отключится.
        </p>
        {consent !== null && (
