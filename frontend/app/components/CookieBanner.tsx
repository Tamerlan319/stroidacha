...
// всегда; Яндекс Метрика и виджеты Яндекса — только после «Принять все».
  ...
  const panel = (
    ...
    >
      <div className={styles.content}>
        ...
        {/* Не «Оставаясь на сайте, вы даёте согласие»: остаться можно и с
            «Только необходимые», тогда согласия нет и Метрика не грузится.
            Согласие даёт кнопка — так текст говорит правду о том, что
            происходит. */}
        <p id="cookie-banner-text">
          Сайт использует cookie-файлы, чтобы сделать ваше пребывание на нём
          максимально удобным. К сайту подключены сервис веб-аналитики Яндекс
          Метрика и карты Яндекса, использующие cookie-файлы. Нажимая «Принять
          все», вы даёте согласие на обработку персональных данных в порядке,
          указанном в{" "}
