...
// внутри меню-бургера. Цели phone_click и messenger_click отправляет общий
// обработчик ссылок в YandexMetrika.tsx (место — mobile_bar), заявка — через
// обычную форму (lead_submit).
