  ...
  return (
    <main className={styles.page}>
      ...
      <p>
        ...
        показывается баннер: необходимые cookie работают всегда, аналитические
        и сторонние — только если нажать «Принять все».
      </p>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Только после «Принять все»</td>
            </tr>
            <tr>
      ...
      <p>
        ...
        или ссылкой «Настройки cookie» в подвале сайта. После отказа Метрика
        перестаёт загружаться. Сохранённые cookie можно удалить в настройках
        браузера.
      </p>
      <p>
