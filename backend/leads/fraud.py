...
# Ниже этой границы за формой заведомо не человек: столько не хватит даже на
# вставку номера из буфера и нажатие кнопки. Такие отправки не сохраняем
# вовсе (см. serializers.validate) — в отличие от «подозрительных», которые
# доходят до менеджеров с пометкой.
HARD_MIN_FORM_FILL_MS = 1200
